...
- Jinlong Zhang, Bing Liu, Su Liu, Zhenhao Feng and Kaiwen Jiang (year). _plantlist: Looking Up the Status of Plant Scientific Names based on The Plant List Database, Searching the Chinese Names and Making checklists of plants_ R package version (X.X.X) https://github.com/helixcn/plantlist/
