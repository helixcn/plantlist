        ...
        if(theme == "complex"){
            ...
            for(i in 1:length(family_list)){
                ...
                for(j in 1:length(temp_genera_list)){
                    ...
                    temp_species_list <- unique(temp_genera_dat$TAXA_NAME)
                    for(k in 1:length(temp_species_list)){
                        temp_species_dat <- subset(temp_genera_dat, temp_genera_dat$TAXA_NAME == temp_species_list[k])
                        main_text <- c(main_text, 
                                       c(# Species Chinese Name
                                           paste("**",unique(temp_species_dat$TAXA_NAME), "**", sep = "", collapse = ""), 
                                           "",                            
                                           ...
                                           "",
                                           paste("**Habitat:**", paste(unique(temp_species_dat$HABITAT)), collapse = ""),
                                           "",
